...
echo "  - hodei-jobs-workers (worker pods)"
echo ""
echo "To verify the installation:"
echo "  kubectl get all -n hodei-jobs-workers"
echo "  kubectl get networkpolicies -n hodei-jobs-workers"
echo ""
echo "To enable the Kubernetes provider in Hodei, set:"
echo "  HODEI_K8S_ENABLED=1"
echo "  HODEI_K8S_NAMESPACE=hodei-jobs-workers"
echo ""
