...
use hodei_jobs_domain::providers::config::{
...
fn map_row_to_provider_config(row: sqlx::postgres::PgRow) -> Result<ProviderConfig> {
    ...
    let provider_type = match provider_type_str.as_str() {
        "DOCKER" => hodei_jobs_domain::workers::ProviderType::Docker,
        "KUBERNETES" => hodei_jobs_domain::workers::ProviderType::Kubernetes,
        "FARGATE" => hodei_jobs_domain::workers::ProviderType::Fargate,
        "CLOUDRUN" => hodei_jobs_domain::workers::ProviderType::CloudRun,
        "CONTAINERAPPS" => hodei_jobs_domain::workers::ProviderType::ContainerApps,
        "LAMBDA" => hodei_jobs_domain::workers::ProviderType::Lambda,
        "CLOUDFUNCTIONS" => hodei_jobs_domain::workers::ProviderType::CloudFunctions,
        "AZUREFUNCTIONS" => hodei_jobs_domain::workers::ProviderType::AzureFunctions,
        "EC2" => hodei_jobs_domain::workers::ProviderType::EC2,
        "COMPUTEENGINE" => hodei_jobs_domain::workers::ProviderType::ComputeEngine,
        "AZUREVMS" => hodei_jobs_domain::workers::ProviderType::AzureVMs,
        "TEST" => hodei_jobs_domain::workers::ProviderType::Test,
        "BAREMETAL" => hodei_jobs_domain::workers::ProviderType::BareMetal,
        "CUSTOM" => hodei_jobs_domain::workers::ProviderType::Custom("custom".to_string()),
        _ => hodei_jobs_domain::workers::ProviderType::Docker,
    };
    ...
    Ok(ProviderConfig {
        ...
        provider_type,
        status,
        capabilities: hodei_jobs_domain::workers::ProviderCapabilities::default(),
        type_config: config,
        priority,
