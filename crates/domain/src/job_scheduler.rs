...
use crate::job_execution::Job;
use crate::worker::Worker;
#[allow(unused_imports)]
use crate::worker_provider::JobRequirements;
...
pub struct ProviderInfo {
    ...
    pub provider_type: crate::worker::ProviderType,
...
mod tests {
    ...
    fn test_lowest_cost_selector() {
        ...
        let job = Job::new(
            ...
            crate::job_execution::JobSpec::new(vec!["echo".to_string()]),
        );
