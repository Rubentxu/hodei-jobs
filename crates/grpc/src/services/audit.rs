...
use hodei_jobs_domain::audit::{AuditQuery, AuditRepository};
...
fn audit_log_to_proto(log: &hodei_jobs_domain::audit::AuditLog) -> AuditLogEntry {
    AuditLogEntry {
        id: log.id.to_string(),
...
mod tests {
    use super::*;
    use hodei_jobs_domain::audit::{AuditLog, AuditQueryResult, EventTypeCount};
    use serde_json::json;
    use std::sync::Mutex;
    use uuid::Uuid;
