...
use hodei_jobs_domain::providers::{ProviderConfig, ProviderTypeConfig};
...
mod tests {
    ...
    use hodei_jobs_domain::providers::{DockerConfig, ProviderConfig, ProviderConfigRepository};
    use std::collections::HashMap;
    use std::sync::Mutex;
    ...
    #[async_trait]
    impl hodei_jobs_domain::providers::ProviderConfigRepository for MockProviderConfigRepository {
    ...
    fn create_docker_config() -> hodei_jobs_domain::providers::ProviderTypeConfig {
        hodei_jobs_domain::providers::ProviderTypeConfig::Docker(DockerConfig::default())
    }
