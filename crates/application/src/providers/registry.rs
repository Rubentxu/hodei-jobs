...
use hodei_jobs_domain::providers::{ProviderConfig, ProviderConfigRepository, ProviderTypeConfig};
use hodei_jobs_domain::shared_kernel::{DomainError, ProviderId, ProviderStatus, Result};
use hodei_jobs_domain::workers::JobRequirements;
...
mod tests {
    use super::*;
    use hodei_jobs_domain::providers::DockerConfig;
