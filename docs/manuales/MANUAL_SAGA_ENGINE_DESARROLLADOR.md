...
The **Saga Engine** is a production-ready workflow orchestration system built on **Event Sourcing** and **Durable Execution** principles. It implements the Saga pattern for distributed transactions with automatic compensation/rollback capabilities.
